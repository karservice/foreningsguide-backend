...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    cookies: Attribute.Component<'misc.cookie-consent'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::config.config',
      'oneToOne',
    ...
    > &
      Attribute.Private;
    favicon: Attribute.Media<'images'> & Attribute.Required;
    footer: Attribute.Component<'layout.footer'> & Attribute.Required;
    metadata: Attribute.Component<'misc.metadata'>;
    navbar: Attribute.Component<'layout.navbar'> & Attribute.Required;
    notificationBanner: Attribute.Component<'misc.notification-banner', true> &
      Attribute.SetMinMax<
        {
          max: 3;
        },
...
export interface ApiDictionaryDictionary extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    word: Attribute.String & Attribute.Required & Attribute.Unique;
  };
}
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sitemap_exclude: Attribute.Boolean &
      Attribute.Private &
      Attribute.DefaultTo<false>;
    slug: Attribute.UID<'api::page.page', 'heading'> & Attribute.Required;
    updatedAt: Attribute.DateTime;
